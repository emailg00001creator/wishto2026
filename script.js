// ===== MAIN APPLICATION =====
// Import modules
import { initParticles, initFireworks, startCelebration } from './js/animations.js';
import { initCountdown, initStats } from './js/countdown.js';
import {
    initWishes,
...
import { scrollToSection, addTouchFeedback, debounce } from './js/utils.js';

// ===== INITIALIZATION =====
document.addEventListener('DOMContentLoaded', () => {
    console.log('%c🎉 Welcome to 2026! 🎉', 'font-size: 30px; color: #667eea; font-weight: bold;');
    console.log('%cInitializing application...', 'font-size: 14px; color: #00f2fe;');
